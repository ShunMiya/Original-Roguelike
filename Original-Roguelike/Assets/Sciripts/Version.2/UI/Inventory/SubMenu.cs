...
namespace UISystemV2
{
    public class SubMenu : MonoBehaviour
    {
        ...
        public void OnSelected()
        {
            ...
            {
                case 0:
                    UseButton.GetComponentInChildren<TextMeshProUGUI>().text = ("使う");
                    break;
                case 1:
                    if (Convert.ToInt32(row["Equipped"]) == 1 || Convert.ToInt32(row["Equipped"]) == 2)
                    {
                        UseButton.GetComponentInChildren<TextMeshProUGUI>().text = ("外す");
                        break;
                    }
                    UseButton.GetComponentInChildren<TextMeshProUGUI>().text = ("装備する");
                    break;
                case 2:
                    UseButton.GetComponentInChildren<TextMeshProUGUI>().text = ("使う");
                    break;
